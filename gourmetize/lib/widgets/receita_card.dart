                    ...
                    child: 
                     Column(
                      children: [
                        ...
                        Container(padding: const EdgeInsets.fromLTRB(10, 10, 0, 0), child: IngredientesGrid(ingredientes: ingredientes))
                      ],
                     )
                  )
                ],
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: Text(
            ingredientes[index],
            style: const TextStyle(color: Color.fromRGBO(230, 193, 11, 100), fontSize: 12),
          ),
        );
      },
    );
